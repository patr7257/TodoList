...
public class Database {
    ...
    public static void loadDatabase(Space users, Space todoLists, Space tasks) throws InterruptedException {
        ...
        // LOAD USERS - test users for demo
        users.put("Alice");
        users.put("Bob");
        users.put("Charlize");
        System.out.println("Loaded 3 users: Alice, Bob, Charlize");
        ...
        todoLists.put("l1", "Shopping", 20, "Bob", Defaults.TASK_COLUMNS_JSON, Defaults.PRIORITY, Defaults.YEAR, 0, "", "");
        todoLists.put("l2", "School", 40, "Alice", Defaults.TASK_COLUMNS_JSON, Defaults.PRIORITY, Defaults.YEAR, 1, "", "");
        todoLists.put("l3", "Work", 60, "Alice", Defaults.TASK_COLUMNS_JSON, Defaults.PRIORITY, Defaults.YEAR, 2, "", "");
        ...
        tasks.put("l1", "tl1_2", "Get milk and eggs", "Charlize", "NOT_STARTED", "2026-01-17", Defaults.PRIORITY, Defaults.YEAR, 1, "", "");
        ...
        tasks.put("l2", "tl2_2", "Study for history exam", "Charlize", "IN_PROGRESS", "", Defaults.PRIORITY, Defaults.YEAR, 1, "", "");
        tasks.put("l2", "tl2_3", "Complete science project", "Bob", "DELAYED", "", Defaults.PRIORITY, Defaults.YEAR, 2, "", "");
        tasks.put("l2", "tl2_4", "Prepare presentation", "Alice", "DONE", "2026-01-15", Defaults.PRIORITY, Defaults.YEAR, 3, "", "");
        taskCount += 4;
        ...
        tasks.put("l3", "tl3_2", "Attend team meeting", "Bob", "DONE", "2026-01-16", Defaults.PRIORITY, Defaults.YEAR, 1, "", "");
        ...
        tasks.put("l3", "tl3_5", "Email client feedback", "Charlize", "NOT_STARTED", "2026-01-10", Defaults.PRIORITY, Defaults.YEAR, 4, "", "");
        ...
        tasks.put("l4", "tl4_2", "Do laundry", "Charlize", "DONE", "", Defaults.PRIORITY, Defaults.YEAR, 1, "", "");
        ...
        tasks.put("l4", "tl4_5", "Water plants", "Alice", "DONE", "", Defaults.PRIORITY, Defaults.YEAR, 4, "", "");
        tasks.put("l4", "tl4_6", "Clean windows", "Alice", "DONE", "", Defaults.PRIORITY, Defaults.YEAR, 5, "", "");
        tasks.put("l4", "tl4_7", "Organize garage", "Bob", "DONE", "", Defaults.PRIORITY, Defaults.YEAR, 6, "", "");
        ...
        tasks.put("l5", "tl5_2", "Reserve hotel room", "Bob", "DONE", "", Defaults.PRIORITY, Defaults.YEAR, 1, "", "");
        ...
        tasks.put("l5", "tl5_5", "Check passport validity", "Alice", "IN_PROGRESS", "", Defaults.PRIORITY, Defaults.YEAR, 4, "", "");
        tasks.put("l5", "tl5_6", "Buy travel insurance", "Alice", "NOT_STARTED", "", Defaults.PRIORITY, Defaults.YEAR, 5, "", "");
        tasks.put("l5", "tl5_7", "Exchange currency", "Charlize", "NOT_STARTED", "", Defaults.PRIORITY, Defaults.YEAR, 6, "", "");
