...
echo "  DATABASE_URL='$DB_URL' TODO_SESSION_SECRET='dev-secret' mvn -pl api exec:java"
echo ""
echo "The UI lives in the PatrickRobelWeb repo. To point it here, run its dev"
echo "server with TODO_API_BASE_URL=http://localhost:8080 :"
echo ""
echo "  cd ../PatrickRobelWeb/website && pnpm dev"
echo ""
